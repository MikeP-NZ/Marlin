...
#define STRING_CONFIG_H_AUTHOR "(Mike Paauwe, UBL)" // Who made the changes.
...
#define MACHINE_UUID "bfdc652c-5921-4dc2-b329-c7e262e5a642"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  52.59
    #define DEFAULT_Ki  07.21
    #define DEFAULT_Kd  95.85
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 80.13
  #define DEFAULT_bedKi 14.82
  #define DEFAULT_bedKd 288.81
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 180, 1600, 285, 285 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 6, 25, 25 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 30, -2 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 70, 245, 20 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  70, 220, (Z_MIN_POS + 1) }, {  105, 220, (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT   { { 75, 245, (Z_MIN_POS + 1) }, {  110, 245, (Z_MIN_POS + 1) } }
